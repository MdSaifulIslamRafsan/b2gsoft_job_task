...
import { FaRegArrowAltCircleLeft, FaRegArrowAltCircleRight, FaStar } from 'react-icons/fa';
import { CiStar } from 'react-icons/ci';
import { Product, products } from '@/lib/productsData';
  ...
  return (
    <section className="p-6 relative min-h-screen">
      ...
      <div className="flex justify-center">
          <Link href="/" className="mt-3 bg-primary-600 text-white  py-2 px-8 rounded-lg hover:bg-primary-700">
          See more
          </Link>
      </div>
    </section>
